          ...
          <div 
            ...
            className="px-5 py-10 bg-white flex justify-between">
              <div className="space-y-2 relative">
                <p className={`absolute -top-8 -left-8 px-10 py-2 text-white uppercase font-bold  rounded-lg ${activity.category=== 1 ? 'bg-blue-950':'bg-orange-500' } `}>
                   {categoryName(+activity.category)}
                </p>
                <p className="text-2xl font-bold pt-5">{activity.activityName}</p>
                <p className=" font-black text-4xl text-blue-950">
                  {activity.calories}{''}
                  <span> Calorias</span>
                </p>
